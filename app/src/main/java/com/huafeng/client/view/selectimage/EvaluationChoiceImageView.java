package com.huafeng.client.view.selectimage;
...
public class EvaluationChoiceImageView extends RelativeLayout implements View.OnClickListener{
    ...
    public List<View> getmFlowlayoutChilds() {
        return mFlowlayoutChilds;
    }

    public void setmFlowlayoutChilds(List<View> mFlowlayoutChilds) {
        this.mFlowlayoutChilds = mFlowlayoutChilds;
    }
...
//                Toast.makeText(mContext, "删除"+mFlowlayoutChilds.indexOf(parent), Toast.LENGTH_SHORT).show();
        ...
        viewEvaluationchoiceimageFlowlayout.addView(evaluationChioceImageItem);
    }
    //添加图片
