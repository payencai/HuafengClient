 ...
 * 邮箱：771548229@qq..com
 */
public class DelGroupUserAdapter extends BaseAdapter {
    Context mContext;
    List<GroupDetail.CrowdUserListBean> mContacts;

    public DelGroupUserAdapter(Context context, List<GroupDetail.CrowdUserListBean> contacts) {
        mContext = context;
        mContacts = contacts;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GroupDetail.CrowdUserListBean contacts=mContacts.get(position);
        ...
        Glide.with(mContext)
                .load(contacts.getHeadPortraitUrl())
