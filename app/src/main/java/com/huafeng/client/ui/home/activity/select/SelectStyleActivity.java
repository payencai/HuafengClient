...
public class SelectStyleActivity extends BaseActivity {
    ...
    FirstTypeAdapter mFristAdapter;
    FirstTypeAdapter mSecAdapter;

    List<FirstType> mFirstCategory;
    List<FirstType> mSecCategory;
    FirstType rawCategory1;
    int currentLevel=1;
    @Override
    ...
    private void initView() {
        ...
        mFristAdapter=new FirstTypeAdapter(this,mFirstCategory);
        mSecAdapter=new FirstTypeAdapter(this,mSecCategory);
        ...
        lv_sec.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                FirstType rawCategory=mSecCategory.get(position);
