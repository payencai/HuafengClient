...
public class RebackGoodsDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reback_goods_detail);
    ...
    private void initView() {
        ...
        iv_goods.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PhotoUtil.seeSinglePhoto(RebackGoodsDetailActivity.this,backTicket.getImagesUrl(),iv_goods);
            }
        });
        getDetail();
    }
    ...
    private void getBack() {
        HttpParams httpParams = new HttpParams();
        httpParams.put("returnBillId", noteid);
        NetUtils.getInstance().get(MyApp.token, Api.Inventory.getReturnBill, httpParams, new OnMessageReceived() {
            @Override
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if (code == 0) {
                        JSONObject data = jsonObject.getJSONObject("data");
                        backTicket = new Gson().fromJson(data.toString(), BackTicket.class);
                        initData();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
    ...
    private void initData() {
        ...
        tv_backnum.setText(backTicket.getReturnQuantity()+"");
        ...
        if(!TextUtils.isEmpty(backTicket.getImagesUrl())){
            ...
            gv_photo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    PhotoUtil.seeBigPhoto(RebackGoodsDetailActivity.this,position,StringUtils.StringToArrayList(backTicket.getImagesUrl(),","),gv_photo.getChildAt(position));
                }
            });
        }
