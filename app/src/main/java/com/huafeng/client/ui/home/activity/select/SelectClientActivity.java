...
import com.huafeng.client.ui.home.adapter.SelectClientAdapter;
...
public class SelectClientActivity extends BaseActivity {
    SelectClientAdapter mWashProcessAdapter;
    List<Client> mWashProcesses;
                ...
                try {
                    ...
                    if (code == 0) {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            Client firstType=new Gson().fromJson(item.toString(),Client.class);
