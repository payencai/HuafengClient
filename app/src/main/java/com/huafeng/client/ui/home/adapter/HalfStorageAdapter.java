 ...
 * 邮箱：771548229@qq..com
 */
public class HalfStorageAdapter extends BaseQuickAdapter<HalfStorage,BaseViewHolder> {
    public HalfStorageAdapter(int layoutResId, @Nullable List<HalfStorage> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, HalfStorage item) {
