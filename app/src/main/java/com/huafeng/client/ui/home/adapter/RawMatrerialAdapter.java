 ...
 * 邮箱：771548229@qq..com
 */
public class RawMatrerialAdapter extends BaseAdapter {
    Context  mContext;
    List<RawMatrerial> mFirstTypes;

    public RawMatrerialAdapter(Context context, List<RawMatrerial> firstTypes) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RawMatrerial firstType=mFirstTypes.get(position);
