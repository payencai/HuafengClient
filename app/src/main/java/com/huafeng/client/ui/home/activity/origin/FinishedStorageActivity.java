...
import com.huafeng.client.ui.home.activity.search.SearchFinishActivity;
...
public class FinishedStorageActivity extends BaseActivity implements DropdownI.SingleRow, DropdownI.RandomView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finished_storage);
    ...
    void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.iv_search:
                startActivity(new Intent(FinishedStorageActivity.this, SearchFinishActivity.class));
                break;
            case R.id.iv_back:
                finish();
                break;
    ...
    private void initView() {
        ...
        finishStorageAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                Intent intent = new Intent(FinishedStorageActivity.this, OriginFinishDetailActivity.class);
        ...
        rv_design.setAdapter(finishStorageAdapter);
        ...
        header= LayoutInflater.from(this).inflate(R.layout.header_origin,null);
        tvNum=header.findViewById(R.id.tv_num);
        tvPrice=header.findViewById(R.id.tv_price);
        finishStorageAdapter.setHeaderView(header);
        getHeader();
        getData();
    }
    private void getHeader(){
       NetUtils.getInstance().get(MyApp.token, Api.Inventory.getQuantityAndAmount, new OnMessageReceived() {
           @Override
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if (code == 0) {
                        ...
                        lvProgress.setSingleRow(FinishedStorageActivity.this)
...
//    FinishStorageAdapter mFinishStorageAdapter;
//    List<FinishStorage> mFinishStorages;
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_finished_storage);
...
//
//    private void initView() {
//        mFinishStorages=new ArrayList<>();
//        mFinishStorageAdapter=new FinishStorageAdapter(R.layout.item_finished_product,mFinishStorages);
//        mFinishStorageAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
//            @Override
//            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
...
//        rv_finish.setAdapter(mFinishStorageAdapter);
//    }
}
