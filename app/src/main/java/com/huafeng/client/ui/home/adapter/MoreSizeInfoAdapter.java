 ...
 * 邮箱：771548229@qq..com
 */
public class MoreSizeInfoAdapter extends BaseAdapter {
    Context  mContext;
    List<SizeType> mFirstTypes;

    public MoreSizeInfoAdapter(Context context, List<SizeType> firstTypes) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SizeType firstType=mFirstTypes.get(position);
