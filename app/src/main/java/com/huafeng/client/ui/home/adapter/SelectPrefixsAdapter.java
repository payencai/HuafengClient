 ...
 * 邮箱：771548229@qq..com
 */
public class SelectPrefixsAdapter extends BaseAdapter {
    Context  mContext;
    List<NoPrefixs> mFirstTypes;

    public SelectPrefixsAdapter(Context context, List<NoPrefixs> firstTypes) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NoPrefixs firstType=mFirstTypes.get(position);
