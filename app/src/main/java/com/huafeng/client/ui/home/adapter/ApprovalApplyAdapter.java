 ...
 * 邮箱：771548229@qq..com
 */
public class ApprovalApplyAdapter extends BaseQuickAdapter<ApprovalApply,BaseViewHolder> {
    public ApprovalApplyAdapter(int layoutResId, @Nullable List<ApprovalApply> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ApprovalApply item) {
        ...
        tv_applvers.setText("审批人："+item.getApproveByName());
