...
public class OriginLogInfoAdapter extends BaseQuickAdapter<OriginStorageDetail.InventoryMaterialLogListBean, BaseViewHolder> {
    public OriginLogInfoAdapter(@Nullable List<OriginStorageDetail.InventoryMaterialLogListBean> data) {
        super(R.layout.item_origin_log, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, OriginStorageDetail.InventoryMaterialLogListBean item) {
