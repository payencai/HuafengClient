 ...
 * 邮箱：771548229@qq..com
 */
public class SelectClientSampleAdapter extends BaseAdapter {
    Context  mContext;
    List<SelectSample> mFirstTypes;

    public SelectClientSampleAdapter(Context context, List<SelectSample> firstTypes) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SelectSample firstType=mFirstTypes.get(position);
        tv_type.setText(firstType.getSampleNo());
