...
public class SearchSupplierAdapter extends BaseQuickAdapter<Supplier, BaseViewHolder> {

    public SearchSupplierAdapter(@Nullable List<Supplier> data) {
        super(R.layout.item_add_supplier, data);
    }
