...
import com.hyphenate.easeui.ui.video.ImageGridActivity;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected static final int REQUEST_CODE_SELECT_VIDEO = 5;
    protected static final int REQUEST_CODE_SELECT_FILE = 6;
...
//        messageList.setAvatarShape(1);
    ...
    private void recall() {
        ...
        EMClient.getInstance().chatManager().aysncRecallMessage(contextMenuMessage, new EMCallBack() {
            @Override
    ...
    private void showMsgDialog() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.ease_msg_dialog, null);
        ...
        tv_item1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ToastUtil.getInstance(getActivity()).showToast("已复制");
            }
        });
        ...
        tv_item3.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog.dismiss();
                forwardMessage(contextMenuMessage.getMsgId());
            }
        });
        tv_item4.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog.dismiss();
                recall();
...
//                }
                //forwardMessage(message.getMsgId());
...
//                    ArrayList<NormalFile> list = data.getParcelableArrayListExtra(Constant.RESULT_PICK_FILE);
                    ...
                    pathList.addAll(data.getStringArrayListExtra(FilePickerConst.KEY_SELECTED_DOCS));
            ...
            switch (itemId) {
                ...
                case ITEM_FILE:
                    FilePickerBuilder.getInstance().setMaxCount(5)
                            ...
                            .addFileSupport("Apk", new String[]{"apk"})
                            .enableDocSupport(true)
                            .enableCameraSupport(true)
                            .enableSelectAll(true)
                            .enableVideoPicker(true)
                            .setActivityTheme(R.style.LibAppTheme)
                            .pickFile(EaseChatFragment.this, REQUEST_CODE_SELECT_FILE);
//                    Intent intent4 = new Intent(getContext(), NormalFilePickActivity.class);
//                    intent4.putExtra(Constant.MAX_NUMBER, 9);
//                    intent4.putExtra(NormalFilePickActivity.SUFFIX, new String[] {"xlsx", "xls", "doc", "docx", "ppt", "pptx", "pdf","mp3","mp4"});
//                    startActivityForResult(intent4, REQUEST_CODE_SELECT_FILE);
                    break;
                default:
                    break;
            }
