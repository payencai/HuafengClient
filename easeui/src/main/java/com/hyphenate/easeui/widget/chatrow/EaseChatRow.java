    ...
    private void setUpBaseView() {
        ...
        if(userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                ...
                if(MyUserProvider.getInstance().getUser(message.getFrom())!=null){
                    EaseUserUtils.setUserAvatar2(context, MyUserProvider.getInstance().getUser(message.getFrom()).getAvatar(), userAvatarView);
                }else{
